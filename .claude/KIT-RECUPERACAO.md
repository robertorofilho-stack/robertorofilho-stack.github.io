...
| `conselho.py` + `/conselho` | fechamento de toda missão estratégica | pede o contra-argumento a GPT, Grok, Gemini e DeepSeek em paralelo; exige `OPENROUTER_API_KEY` fora do git (web: variáveis do ambiente; Mac: `~/.config/cerebro/conselho.env`) |
