...
| Fábrica de carrossel (slides.json → imagens 1080×1350, guarda anti-estouro) | `.claude/producao/carrossel/` | 🟢 11 slides renderizados · QA 4/4 | 2026-09-18 |
...
|---|---|---|---|---|
| Carrossel "Graphify: os números reais" (11 slides + legenda + Reels 38s) | Instagram / TikTok | — não publicado | — | 2026-09-18 |
